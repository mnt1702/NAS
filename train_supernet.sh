...
python3 train_supernet.py run \
  ...
  python3 train_supernet.py run --backbone resnet48_mish  --max_epoch 70   --batch_size 256  --lr 0.001   --warmup 5   --dyna_batch_size 4   --pretrained checkpoints/resnet48.pdparams --save_dir checkpoints/reproduct_rank_loss_flops_sanwich   --log_freq 50   --visualdl_dir "./visualdl_log/reproduct_rank_loss_flops_sanwich"   --image_dir G:\RESEARCH\NCKH2023\Dataset\Imagenet_1k\imagenet-mini
